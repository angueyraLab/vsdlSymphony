    ...
    methods
        ...
        function obj = Preparation()
            ...
            obj.addProperty('dissectedBy', 'Angueyra', ...
                'type', PropertyType('char', 'row', {'', 'Angueyra', 'Carinna', 'Meghan', 'Leah', 'Usuy', 'Jared'}), ...
            ...
            obj.addProperty('bathSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'DMEM', 'E3', 'AmesBicarb', 'AmesHEPES', 'HibA'}), ...
                'description', 'The solution the tissue is bathed in during experiments');   
            obj.addProperty('storageSolution', '', ...
                'type', PropertyType('char', 'row', {'', 'DMEM', 'E3', 'AmesBicarb', 'AmesHEPES', 'HibA','CustomCultureMedium'}), ...
                'description', 'The solution the tissue is stored in');
            obj.addProperty('storageTemp', '', ...
                'type', PropertyType('char', 'row', {'', 'incubator', 'fridge', 'room temp', 'warm', 'body temp'}), ...
